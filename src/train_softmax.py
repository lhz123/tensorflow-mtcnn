    ...
    with tf.Graph().as_default():
        ...
        for _ in range(nrof_preprocess_threads):
            ...
            for filename in tf.unstack(filenames):
                file_contents = tf.read_file(filename)#图片的读取
...
def parse_arguments(argv):
    ...
    parser.add_argument('--max_nrof_epochs', type=int,
                        help='Number of epochs to run.', default=50)#default=500
    parser.add_argument('--batch_size', type=int,
                        help='Number of images to process in a batch.', default=5)#default=90
    ...
    parser.add_argument('--lfw_batch_size', type=int,
                        help='Number of images to process in a batch in the LFW test set.', default=2)#default=100
